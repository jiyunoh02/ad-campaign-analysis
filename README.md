...
This project analyzes the performance of paid social media campaigns using A/B testing across Instagram and TikTok. The goal is to identify which creative strategies drive higher click-through rates and engagement.

- **Total budget:** ₩300,000 KRW (~$230 USD)
- **Duration:** 4 weeks
- **Platforms:** Instagram Ads, TikTok Ads
- **Creatives tested:** 4 video ads across 2 experiments
- **Overall conversion rate:** TikTok 34% / Instagram 30.3% (ad click → website action)
...
- Instagram: Influencer avg **2.45%** vs General **1.48%**
- TikTok: Influencer avg **1.41%** vs General **1.04%**

> **Insight:** On Instagram, fans responded more strongly to recognizable influencer faces — consistent with the hypothesis that recognition drives clicks in a fan-platform context. The gap was smaller on TikTok, likely because TikTok's algorithm surfaces content based on behavior rather than brand recognition.
...
- Instagram: Close-up avg CTR **1.94%** vs Full-shot **1.56%**
- TikTok: Close-up avg CTR **1.25%** vs Full-shot **1.10%**
...
- **Instagram** drove higher CTR overall and showed a larger gap between influencer and general creatives
- **TikTok** showed higher conversion rates (TikTok **34.4%** vs Instagram **28.6%**) despite lower CTR — users who clicked on TikTok were more likely to take action on the landing page

> **Recommendation:** For an influencer-fan platform in early stages, prioritize influencer close-up creatives and allocate more budget to Instagram for CTR efficiency. Use TikTok for conversion-focused campaigns targeting warmer audiences.
...
- **Platforms** — Instagram Ads Manager, TikTok Ads
